...
# =============================================================================
# install-newsroom.sh
# Downloads and extracts onweru/newsroom (master) and sets up tina + config
# =============================================================================
...
# Configuration
# -------------------------------
REPO_URL="https://github.com/onweru/newsroom/archive/refs/heads/master.zip"
ZIP_FILE="cms.zip"
EXTRACT_DIR="cms"
TEMP_DIR="temp_$(date +%s)_$$"  # Unique temp dir
TARGET_DIR="./cms"
EXAMPLE_SITE="newsroom-master/exampleSite"
...
# mkdir temp
# mv cms/newsroom-master/exampleSite/* cms/newsroom-master/exampleSite/.* temp
# rm -rf cms
# mv temp/tina tina
